...
class Encoder:
    def __init__(self, encoder, bpe_merges):
        ...
        self.byte_decoder = {v:k for k, v in self.byte_encoder.iters()}
...
def get_file(local_file, remote_file):
    if not os.path.is_file(local_file):
...
def get_encoder():
    ...
    vocab_local_file = os.path.join(cache_dir, 'vocabe.bpe')
